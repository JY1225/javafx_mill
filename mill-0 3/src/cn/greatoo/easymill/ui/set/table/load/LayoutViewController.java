...
public class LayoutViewController {
	...
	public void init(GridPane setProsessPane) {
		...
		studPositions = new StudPosition[6][26];
...
//				}
				...
				// add plate
				stackPlate = new Rectangle(0, 0, 500, 200);
				stackPlate.getStyleClass().add(CSS_CLASS_STACKPLATE);
				layoutPane.getChildren().add(stackPlate);

//				initStuds();

				if (0/* basicStackPlate.getLayout().getStackingPositions().size() */ > 0) {
...
//				updateScale();
	...
	private void initStuds() {   	
        ...
        for(int i = 0;i < 7;i++) {
        	for(int j = 0;j < 27;j++) {        		
        		studPositions[i][j] = null;
        	}
        }
        for (StudPosition[] horizontalPositions : studPositions) {
            Text txt = new Text(""  + (char) ('A' + (index - 1)));
//            Text[text="A", x=-10.0, y=467.5
//            (45.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (80.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (115.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (150.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (185.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (220.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (255.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (290.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (325.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (360.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (395.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (430.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (465.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            (500.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (535.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (570.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (605.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (640.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (675.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (710.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (745.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (780.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (815.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (850.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (885.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (920.0, 26.0, 0.0, 0.0, 0.0, 0.0), 
//            Stud[NONE] at (955.0, 26.0, 0.0, 0.0, 0.0, 0.0)]
            txt.setX(-10);
            ...
            for (StudPosition pos : horizontalPositions) {
                ...
                Circle hole = new Circle(pos.getCenterPosition().getX(), width - pos.getCenterPosition().getY(), 2 / 2);
                holes.add(hole);
	...
	private void configureStuds() {
		// BasicStackPlateLayout layout = (BasicStackPlateLayout)
		// basicStackPlate.getLayout();
		for (StudPosition[] horizontalPositions : studPositions) {
			for (StudPosition pos : horizontalPositions) {
