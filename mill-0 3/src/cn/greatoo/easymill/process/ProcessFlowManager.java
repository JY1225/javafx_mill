...
import cn.greatoo.easymill.robot.RobotPutSettings;
...
public class ProcessFlowManager {
	...
	public ProcessFlow createNewProcessFlow() {
		...
		robotPickSettings.setWorkPiece(finishedWorkPiece);
		robotPickSettings.setSmoothPoint(smoothPoint);
		robotPutSettings.setSmoothPoint(smoothPoint);
//
//	
